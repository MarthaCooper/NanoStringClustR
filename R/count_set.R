...
#'
#' @description Generates a summerized experiment from mRNA NanoString count
#' data in an nSolver RCC Collector Tool Format or matrix and (optional) sample
#' annotations including group, batch, and sample pairing.
#'
...
#' @param low_reps Force CountSet to build if a group contains less than
